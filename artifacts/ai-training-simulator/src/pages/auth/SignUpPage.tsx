    ...
    <div className="min-h-[100dvh] grid grid-cols-1 md:grid-cols-2 bg-background">
      ...
      <div className="hidden md:flex flex-col justify-between p-12 bg-sidebar border-r border-sidebar-border relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl font-display font-bold text-white mb-4 leading-tight">Accelerate your team's mastery.</h1>
          <p className="text-sidebar-foreground/70 text-lg">Create an account to start building or taking intelligent training simulations.</p>
        </div>
